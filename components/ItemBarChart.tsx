...
interface Props {
  ...
  title?: string;
  limit?: number;
  /** Unit shown in the tooltip/title — "ชิ้น" by default, but e.g. "เซต" for
...
export default function ItemBarChart({
  ...
  const resolvedTitle = title ?? `จำนวนรายการสูงสุด (${unit})`;
  const sorted = [...data]
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-md overflow-hidden">
      <ReportSectionHeader title={resolvedTitle} icon={BarChart3} />
      <div className="p-5">
